...
// #include <string.h>
// #include <stdio.h>
// #include "../persistence/sdb.h"  // Add this include

// extern pthread_mutex_t sdb_mutex;  // Declare external mutex
// extern ReplicationState *repl_state;  // Declare external state
