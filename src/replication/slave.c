...
// static void execute_command(int socket, RedisCommand *cmd);
...
//     char sync[] = "*1\r\n$4\r\nSYNC\r\n";
//     write(slave->master_socket, sync, strlen(sync));
// }


// static void execute_command(int socket, RedisCommand *cmd) {
//     // Implementation depends on your command execution system
